...
# Load object classes from data.csv
data = pd.read_csv('data.csv')
CLASSES = data['object_name'].tolist()

# Define specific colors for each class (BGR format)
COLOR_MAPPING = {
    "background": (0, 0, 0),
    "aeroplane": (0, 255, 0),
    "bicycle": (255, 0, 0),
    ...
    "dog": (0, 0, 128),
    "horse": (192, 192, 192),
    "motorbike": (128, 128, 128),
    "person": (0, 255, 128),
    "pottedplant": (128, 255, 0),
    "sheep": (128, 0, 255),
    "sofa": (255, 128, 0),
    "train": (0, 128, 255),
    "tvmonitor": (255, 0, 128)
...
# Generate colors for each class from COLOR_MAPPING
COLORS = [COLOR_MAPPING[cls] if cls in COLOR_MAPPING else (255, 255, 255) for cls in CLASSES]
